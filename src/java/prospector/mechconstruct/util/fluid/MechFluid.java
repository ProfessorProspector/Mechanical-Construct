...
public class MechFluid extends Fluid {
	public MechFluid(String fluidName, int density, int viscosity, int temperature, int luminosity) {
		super(fluidName, new ResourceLocation(MechConstruct.MOD_ID, "fluid/" + fluidName + "/" + fluidName + "_still"), new ResourceLocation(MechConstruct.MOD_ID, "fluid/" + fluidName + "/" + fluidName + "_flowing"));
		setDensity(density);
